...
LEGACY_OUTPUT_JSON = ".agent/skills/skill_director/skill_intelligence.json"
ISOLATED_OUTPUT_JSON = ".agent/skills/skill_director/_generated/skill_intelligence.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "'isolated' writes to .agent/skills/skill_director/_generated (default). "
            "'legacy' writes to .agent/skills/skill_director."
        ),
    )
    parser.add_argument(
        "--director-mode",
    ...
    parser.add_argument(
        "--wisdom-local-ledger",
        default=".agent/skills/skill_director/wisdom/session_wisdom.jsonl",
        help="Local canonical wisdom ledger path.",
    )
    parser.add_argument(
        "--wisdom-global-codex-ledger",
        default=str(codex_home_default / "skills" / "skill_director" / "wisdom" / "global_wisdom.jsonl"),
        help="Global codex wisdom mirror ledger path.",
    )
    parser.add_argument(
        "--wisdom-global-antigravity-ledger",
        default=str(Path.home() / ".gemini" / "antigravity" / "skills" / "skill_director" / "wisdom" / "global_wisdom.jsonl"),
...
def gather_director_candidates(
    ...
    for root in roots:
        if not root.path.exists():
            continue
        candidates = list(root.path.rglob("skill_director/SKILL.md"))
    ...
    *,
    ...
    for ws in workspaces:
        candidate_paths.append(
            (ws / ".agent" / "skills" / "skill_director" / "wisdom" / "session_wisdom.jsonl", str(ws), "workspace_session_wisdom")
        )
        candidate_paths.append(
            (ws / ".agent" / "skills" / "skill_director" / "skill_intelligence.json", str(ws), "workspace_skill_intelligence")
        )
        candidate_paths.append(
            (
                ws / ".agent" / "skills" / "skill_director" / "_generated" / "skill_intelligence.json",
                str(ws),
