...
```json
{
  ...
  "local_route_prereq_failures": ["string"],
  "cooldown_safe": true,
  "runtime_provenance": {
    "mock_runtime_runs": 0,
    "real_runtime_runs": 0,
    "mock_runtime_detected": false,
    "real_runtime_detected": false,
    "mock_counts_toward_cooldown": false,
...
```json
{
  ...
  "rows": [
    {
      ...
      "available": true,
      "detail": "string",
      "source": "adapter|request|derived"
    }
  ],
  "local_route_prereqs": [
    {
  ...
  "effective_state_proof": [
    {
      "feature": "string",
      "requested": true,
      "provider_available": true,
      "effective_available": true,
      "missing_local_prereqs": ["string"],
      "reason_code": "available|provider_or_entitlement_unavailable|missing_local_prerequisite"
    }
  ],
  "runtime_provenance": {
    "mock_runtime_runs": 0,
